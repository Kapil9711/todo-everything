...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ height: "500px" }}
        className=" w-2 relative bg-orange-500 border border-orange-500 "
      >
        <div
          // id="a"
          className="absolute top-2 left-0 w-32 h-32 border-t-4 rounded-full border-orange-500"
        ></div>
        <div
          // id="b"
          className="w-32 absolute top-48 -left-32 h-32  border-t-4 rounded-full border-orange-500"
        ></div>
        <div
          // id="c"
          className="w-32 h-32 absolute -bottom-16  left-0 border-t-4 rounded-full   border-orange-500"
        ></div>

        <div id="a" className="absolute top-16 left-40 w-96 ">
          <strong className="text-xl sm:text-2xl">Introduction :</strong>
          <p className="max-w-96 mx-auto  p-2  mt-4  border border-orange-500 leading-7 tracking-wide text-gray-400 hover:text-gray-300 sm:text-xl sm:pl-4 sm:max-w-2/3  sm:hover:scale-105 transition-all duration-500 ease-in-out">
        ...
        <div id="b" className="absolute top-56 -left-96 w-96 -ml-40">
          ...
          <p className="max-w-96 mx-auto  sm:pl-4  p-2 mt-4  border border-orange-500 leading-7 tracking-wide text-gray-400 hover:text-gray-300 sm:text-xl sm:max-w-2/3  sm:hover:scale-105 transition-all duration-500 ease-in-out">
        ...
        <div id="c" className="absolute top-96 left-40 w-96 mt-28">
